...
- The Stable Brief is the orientation prefix. One Delta is captured on genuine user input, frozen through its tool continuations, and never persisted or sent as a separate message. Later tool results supersede its snapshot; reconcile stale or unconfirmed baselines before use.
