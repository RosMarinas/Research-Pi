...
On WSL2, persistent project trust is limited to exact opaque SSH targets. Host
commands and project scripts remain one-shot, cannot address `/mnt`, and cannot
launch Windows, PowerShell, cmd, WSL, or Explorer executables. See the
[Windows / WSL2 guide](docs/windows-wsl-guide.md) for the enforced boundary.
